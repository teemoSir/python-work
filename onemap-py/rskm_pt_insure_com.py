...
def getdata():
    ...
    action = "/api/syncinsurance/getinsorg"
...
def connPgInstall():
    ...
    try:
        ...
        cur = conn.cursor()
        sql = "INSERT INTO public.rskm_pt_insure_com( insurcompanycode, insurcompanyname, description, area_list, order_index) VALUES (%s, %s, %s, %s, %s);"
        print("入库内容")
...
def write_json(text):
    ...
    # 构建文件名
    filename = f"data/com_{now.year}_{now.month}_{now.day}.json"
